...
if CONTINUE:
    generator.load_state_dict(torch.load(
        '/content/drive/My Drive/cs515_home/data/models/G_epoch_4'))
    discriminator.load_state_dict(torch.load(
        '/content/drive/My Drive/cs515_home/data/models/D_epoch_4'))
else:
...
out_dir_model = '/content/drive/My Drive/cs515_home/data/models/'
out_dir_images = '/content/drive/My Drive/cs515_home/data/images'
home_dir = '/content/drive/My Drive/cs515_home/'
make_dir(home_dir)
...
for epoch in range(num_epochs):
    for n_batch, (real_batch, _) in enumerate(train_loader):
        ...
        print("Discriminator real accuracy:{0}, Discriminator fake accuracy:{1}, "
              ...
              format(d_pred_real.data.mean(), d_pred_fake.data.mean(), epoch + 1, n_batch, num_batches))
        ...
        if n_batch % 100 == 0:  # save figures and models, display results
            ...
            plt.imshow(np.moveaxis(grid.numpy(), 0, -1), cmap='gray_r')
            plt.axis('off')
