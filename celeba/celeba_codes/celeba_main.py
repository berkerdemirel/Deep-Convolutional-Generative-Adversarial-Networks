...
batch_size = 128
train_set = torchvision.datasets.ImageFolder(data_set_dir, train_transformation)
# Use sampler for randomization
training_sampler = torch.utils.data.SubsetRandomSampler(range(len(train_set)))

# Prepare Data Loaders for training and validation
train_loader = torch.utils.data.DataLoader(train_set, batch_size=batch_size, sampler=training_sampler,
...
if CONTINUE:
    generator.load_state_dict(torch.load(
        'C:/Users/berkerdemirel/PycharmProjects/cs515_gan_proj/home/data/models/G_epoch_0'))
    discriminator.load_state_dict(torch.load(
        'C:/Users/berkerdemirel/PycharmProjects/cs515_gan_proj/home/data/models/D_epoch_0'))
else:
